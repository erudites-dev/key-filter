...
gradle.projectsEvaluated {
    ...
    publishMods {
        ...
        if (neoforgeEnabled) {
            if (curseforgeEnabled) {
                curseforge("curseforgeNeoforge") {
                    ...
                    displayName = "Key Filter ${BuildConfig.MOD_VERSION} for NeoForge ${BuildConfig.MINECRAFT_VERSION}"
                }
            }
        ...
        github {
            ...
            repository = "erudites-dev/key-filter"
            commitish = "main"
            ...
            displayName = "Key Filter ${BuildConfig.MOD_VERSION} for Minecraft ${BuildConfig.MINECRAFT_VERSION}"
